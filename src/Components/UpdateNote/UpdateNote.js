...
class UpdateNote extends Component {
  ...
  render() {
    // console.log(this.props.history.location.pathname.split("/")[2] +" ///// "+ this.props.userData.data[0].token);
    return (
      <Fragment>
...
const mapDispatchToProps = (dispatch) => {
  return {
    editNote: (noteId, noteText, Authorization) =>
      dispatch(editNote(noteId, noteText, Authorization)),
